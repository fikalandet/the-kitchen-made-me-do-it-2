...
interface NewMenuEditorProps {
  ...
  onSettingsChange: (settings: NewMenuSettings) => void;
}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Nytt på menyn</h3>
          <p className="text-sm text-gray-600">Anpassa inställningar för Nytt på menyn-sektionen</p>
        </div>
      </div>
